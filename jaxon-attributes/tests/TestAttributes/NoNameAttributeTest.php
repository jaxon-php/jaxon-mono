...
class NoNameAttributeTest extends TestCase
{
    ...
    public function testContainerAttribute()
    {
        ...
        $this->assertEquals(AttributeNoName::class, $di1['colorService'][1]);
        $this->assertEquals(FontService::class, $di1['fontService'][0]);
        $this->assertEquals(AttributeNoName::class, $di1['fontService'][1]);
        $this->assertEquals(ColorService::class, $di2['colorService'][0]);
        $this->assertEquals(AttributeNoName::class, $di2['colorService'][1]);
        $this->assertEquals(TextService::class, $di2['textService'][0]);
        $this->assertEquals(AttributeNoName::class, $di2['textService'][1]);
    }
    ...
    public function testClassAttribute()
    {
        ...
        $this->assertEquals(ClassAttributeNoName::class, $di['colorService'][1]);
        $this->assertEquals(TextService::class, $di['textService'][0]);
        $this->assertEquals(ClassAttributeNoName::class, $di['textService'][1]);
        $this->assertEquals(FontService::class, $di['fontService'][0]);
        $this->assertEquals(ClassAttributeNoName::class, $di['fontService'][1]);
    }
